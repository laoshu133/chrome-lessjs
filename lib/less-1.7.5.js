...
function loadFile(originalHref, currentFileInfo, callback, env, modifyVars) {
    ...
    less.doXHR(href, env.mime, function (data, lastModified) {
        // per file cache
        fileCache[href] = data;
            ...
            if (less.watchMode) {
                loadStyleSheets(function (e, root, _, sheet, env) {
                    if (e) {
                        ...
                        less.createCSS(styles, sheet, env.lastModified);
                    }
                });
            }
        }, less.poll);
